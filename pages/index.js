            ...
            <main className="py-10 mx-auto max-w-screen-2xl">
                <div className="px-6 xlg:px-0">
                    ...
                    <ol className="mt-3 ml-4 list-decimal">
                        ...
                        <li>
                            Enter your booking details and send your reservation. You will receive an email with a link
                            to your booking information, which you can use to cancel your reservation if necessary.
                        </li>
                    </ol>
                </div>
