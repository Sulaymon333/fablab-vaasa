...
function Header() {
    ...
    return (
        <header className="relative p-6 bg-yellow-300">
            <nav className="flex justify-between mx-auto text-gray-700 max-w-screen-2xl">
                ...
                <ul className="flex items-center space-x-5" onMouseEnter={handleMouseEnter}>
                ...
                {mouseEntered && <Checkout basketItems={items} removeItemFromBasket={removeItemFromBasket} />}
            </nav>
        </header>
    );
}
